...
#ifndef FORCESENSORBASE_HPP
#define FORCESENSORBASE_HPP
...
public:
  ...
  virtual void exit() = 0;
  virtual void storeSensorOffset(std::string filename, unsigned int
    nr_elements_for_filter) = 0;
